                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                           ...
                           <a href="{{URL::to('/student_edit/'.$v_student->student_id)}}"> <button class="btn btn-outline-warning">Edit</button>
                           <a href="{{URL::to('/student_delete/'.$v_student->student_id)}}" id="delete"> <button href="" class="btn btn-outline-danger">Delete</button>
                          </td>
                      </tr>
                      @endforeach
                    </tbody>
